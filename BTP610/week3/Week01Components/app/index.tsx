...
import { Switch, Text, View, Image, TextInput, Platform, ScrollView, Button, Alert, Pressable, TouchableOpacity } from "react-native";
  ...
  return (
    <ScrollView>
      <View style={appStyle.mainView}>
        ...
        <View style={[appStyle.checkboxRow, { width: '90%' }]}>
          ...
          <Switch
            ...
            thumbColor={isSwitchOn ? 'green' : 'lightslategray'} />
        </View>
